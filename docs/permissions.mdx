...
Role create, assign, and unassign require Gigi's Discord bot role to have `Manage Roles` and to sit higher in the Discord role hierarchy than the target role.
