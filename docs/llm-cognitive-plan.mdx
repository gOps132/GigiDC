...
- A typed planner contract for intents, context requests, tool calls, clarification questions, and confirmation requirements. Started with a multi-planner chain: deterministic native-tool heuristics first, then LLM-backed memory planning.
