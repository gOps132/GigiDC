...
<Columns cols={2}>
  ...
  <Card title="Architecture" href="/architecture-v1">
    Understand the DM-first and mention-aware runtime, permissions, memory, and data boundaries.
  </Card>
...
- DM-first interaction plus mention-based channel conversation for questions and follow-ups
...
- [Setup](./setup)
- [Knowledge Workflow](./knowledge-workflow)
