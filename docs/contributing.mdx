...
- Keep agent artifacts in local ignored `.agents/` only. This includes superpowers plans, agent planning notes, agent reports, and scratch artifacts.
- Do not commit agent artifacts, superpowers plans, private planning notes, local harnesses, tokens, `.env` files, or raw exported private data.
