...
- Most behavior sits in services, especially the DM retrieval path, the shared-identity task/action path, and the admin command path for assignments, ingestion, relay dispatch, and task tracking.
