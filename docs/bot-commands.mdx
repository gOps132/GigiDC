...
`model` is optional. If omitted or set to `auto`, Gigi selects a static default based on the credential provider and purpose. Pass a provider model ID to override the default.
