...
All `/plugins` commands are live admin commands for the external app manifest catalog. They do not drive external app behavior yet.
...
Enables an approved external app version for the current Discord server. This does not execute external app commands yet.
