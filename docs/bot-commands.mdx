...
Status: live for exact current-channel count questions matching `how many times did @user mention "text"?`.
...
Count answers use deterministic SQL over indexed messages. Gigi does not ask an LLM to guess aggregate counts.
