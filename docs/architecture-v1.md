...
Discord login is at the gateway-adapter stage and is disabled by default through `GIGI_DISCORD_ENABLED=false`. Plugin execution, retrieval, and LLM calls are intentionally not active yet.
